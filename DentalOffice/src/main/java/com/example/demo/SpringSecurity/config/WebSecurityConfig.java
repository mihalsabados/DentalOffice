...
import com.example.demo.SpringSecurity.auth.RestAuthenticationEntryPoint;
import com.example.demo.SpringSecurity.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/dentalOffice/**").permitAll()
